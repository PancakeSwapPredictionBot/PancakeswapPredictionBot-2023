...
1. ``git clone https://github.com/PancakeBotPrediction/Pancakeswap-Prediction-Bot-2023`` 
2. ``cd Pancakeswap-Prediction-Bot-2023`` (replace with your cloned/downloaded bot folder)
3. ``npm i``
