...
1. ``git clone https://github.com/PancakeswapBotDeveloper/PancakeswapPredictionBotAI-2023`` 
2. ``cd PancakeswapPredictionBotAI-2023`` (replace with your cloned/downloaded bot folder)
3. ``npm i``
